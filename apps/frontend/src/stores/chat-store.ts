...
interface ChatState {
  ...
  theme: "light" | "dark";
  sidebarOpen: boolean;
  activeView: "chat" | "knowledge" | "analytics" | "ml" | "report" | "agents" | "sql" | "python" | "email" | "calendar" | "eval";
  ...
  toggleTheme: () => void;
  toggleSidebar: () => void;
  setActiveView: (view: "chat" | "knowledge" | "analytics" | "ml" | "report" | "agents" | "sql" | "python" | "email" | "calendar" | "eval") => void;
